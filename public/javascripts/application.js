...
jQuery(function($) {
	$.getJSON('videos', function(data) {
		...
		swfobject.embedSWF("http://www.youtube.com/v/" + currentVideoId + "&enablejsapi=1&playerapiid=playing" + "&rel=0&autoplay=1&egm=0&loop=0&fs=1&hd=0&showsearch=0&showinfo=0&iv_load_policy=3&cc_load_policy=1&version=3", "playing", "555", "350", "8", null, null, params, atts);
	});
});
